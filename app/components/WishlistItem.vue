...
<template>
  ...
  >
    ...
    <div class="flex-shrink-0 flex items-center gap-2">
      ...
      <div v-if="isAdmin" class="flex items-center gap-0.5 ml-1">
        <button
        ...
        <button class="p-2 rounded-lg text-gray-300 hover:text-blue-500 transition-colors" @click.stop="emit('edit', item)">
          <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
          </svg>
        </button>
        <button class="p-2 rounded-lg text-gray-300 hover:text-red-500 transition-colors" @click.stop="emit('delete', item.id)">
          <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
